...
import axiosInstance from "@/lib/api"; // Use the configured axios instance
...
export default function LoginPage() {
  ...
  const handleValidation = useCallback(() => { // Wrap with useCallback
  ...
  const onLogin = async () => {
    ...
    try {
      setLoading(true);
      // Use axiosInstance for the login API call
  ...
  useEffect(() => {
    handleValidation();
  }, [user, handleValidation]); // Add handleValidation to useEffect dependencies
